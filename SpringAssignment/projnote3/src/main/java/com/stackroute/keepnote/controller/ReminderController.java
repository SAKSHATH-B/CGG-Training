...
public class ReminderController {
  ...
  public ResponseEntity<?> createReminder(
    ...
    try {
      reminder.setReminderCreatedBy(user.getUserId());
      boolean createdReminder = reminderService.createReminder(reminder);
      return new ResponseEntity<>(
        "Reminder created status " + createdReminder,
        HttpStatus.CREATED
      );
    } catch (Exception e) {
  ...
  public ResponseEntity<?> deleteReminder(
    ...
    try {
      boolean deleteReminder = reminderService.deleteReminder(id);
      return new ResponseEntity<>(
        "Reminder deleted status " + deleteReminder,
        HttpStatus.OK
      );
    } catch (Exception e) {
      // TODO: handle exception
  ...
  public ResponseEntity<?> getAllRemindersByUserId(HttpSession session) {
    ...
    try {
      ...
      getRemindersByUserId = reminderService.getAllReminderByUserId(userId);
      return new ResponseEntity<>(getRemindersByUserId, HttpStatus.OK);
    } catch (Exception e) {
      // TODO: handle exception
      return new ResponseEntity<>(e.getMessage(), HttpStatus.NOT_FOUND);
    }
