...
public class Isbn implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    Isbn other = (Isbn) obj;
    if (isbn1 == null) {
      if (other.isbn1 != null) return false;
    } else if (!isbn1.equals(other.isbn1)) return false;
    if (isbn2 == null) {
      if (other.isbn2 != null) return false;
    } else if (!isbn2.equals(other.isbn2)) return false;
    return true;
  }
}
